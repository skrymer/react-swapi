...
export type Vehicle = {
    ...
    films: url[], // An array of Film URL Resources that this vehicle has appeared in.
    pilots: url[], // An array of People URL Resources that this vehicle has been piloted by.
